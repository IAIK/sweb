...
#define debugAlways(flag,fmt,args...) do { if (flag & 0x80000000) { printf("[%-11s] ", #flag); printf(fmt,## args); } } while(0)
#define debugAdvanced(flag,fmt,args...) do { if (flag & 0x80000000) { printf("[%-11s] ", #flag); printf(fmt,## args); } } while(0)
