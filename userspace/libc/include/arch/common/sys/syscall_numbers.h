 ...
 *
 * $Id: syscall_numbers.h,v 1.4 2005/09/14 23:12:16 aniederl Exp $
 * $Log: syscall_numbers.h,v $
 * Revision 1.3  2005/09/11 13:13:34  aniederl
...
#ifndef syscall_numbers_h___
#define syscall_numbers_h___

/**
 * Syscall numbers which are used for executing syscalls
 * taken from http://www.lxhp.in-berlin.de/lhpsyscal.html
 *
 * Note that a syscall listed here is not necessarily implemented.
 *
 */

#define __NR___syscall_exit 1
#define __NR_fork 2
#define __NR_read 3
#define __NR_write 4
