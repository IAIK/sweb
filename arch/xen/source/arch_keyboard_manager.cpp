...
//----------------------------------------------------------------------
//   $Id: arch_keyboard_manager.cpp,v 1.2 2005/09/22 09:07:04 nightcreature Exp $
//----------------------------------------------------------------------
//
...
KeyboardManager::KeyboardManager() : extended_scancode( 0 ), keyboard_status_ ( 0 ), keyboard_buffer_(256)
{
}
...
void KeyboardManager::kb_wait()
{
  ...
  if (i>=0x10000)
    kprintfd("KeyboardManager::kb_wait: waitiong on 0x02 didn't speed up things :-(\n");
}
