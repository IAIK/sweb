...
do {									\
	vcpu_info_t *_vcpu;						\
	_vcpu = &HYPERVISOR_shared_info_->vcpu_info[smp_processor_id()];	\
...
#define irqs_disabled()			\
    HYPERVISOR_shared_info_->vcpu_info[smp_processor_id()].evtchn_upcall_mask
...
//#define rmb()  alternative("lock; addl $0,0(%%esp)", "mfence",X86_FEATURE_XMM2)
