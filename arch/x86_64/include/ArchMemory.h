...
#include "types.h"
#include "offsets.h"
#include "../../x86/include/paging-definitions.h"
 ...
 */
  bool mapPage(uint64 virtual_page, uint64 physical_page, uint32 user_access, uint32 page_size=PAGE_SIZE);
 ...
 */
  bool checkAddressValid(uint64 vaddress_to_check);
