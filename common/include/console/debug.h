...
const uint32 A_BOOT             = 0x00400001 | OUTPUT_ENABLED;
const uint32 A_COMMON           = 0x00400002;
const uint32 A_MEMORY           = 0x00400004;
const uint32 A_SERIALPORT       = 0x00400008;
const uint32 A_KB_MANAGER       = 0x00400010;
const uint32 A_INTERRUPTS       = 0x00400020;
