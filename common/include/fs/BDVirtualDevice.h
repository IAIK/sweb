...
class BDVirtualDevice
{
  public:
     ...
     *
     */
    virtual __attribute__((warn_unused_result)) int32 readData(uint32 offset, uint32 size, char *buffer);
     ...
     *
     */
    virtual __attribute__((warn_unused_result)) int32 writeData(uint32 offset, uint32 size, char *buffer);
